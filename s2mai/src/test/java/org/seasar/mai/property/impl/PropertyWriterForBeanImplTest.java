...
public class PropertyWriterForBeanImplTest extends S2TestCase {
    ...
    public void testSetMailProperty() throws UnsupportedEncodingException, MalformedURLException {
        ...
        Object[] tos = new Object[] { "test@address", new InternetAddress("test2@address", "送信先") };
        testDto3.setTo(tos);
        String[] ccs = new String[] { "cc1@address", "cc2@address" };
        testDto3.setCc(ccs);

        InternetAddress[] bccs = new InternetAddress[] { new InternetAddress("bcc1@address", "BCC送信先1"),
    ...
    public class TestDto {
        ...
        public final void setBcc(List bcc) {
            this.bcc = bcc;
        }
    ...
    public class TestDto2 {
        ...
        public final AttachedFile[] getFiles() {
            return files;
        }

        public final void setFiles(AttachedFile[] files) {
            this.files = files;
        }

        public final AttachedFile getTempuFile() {
            return tempuFile;
        }
    ...
    public class TestDto3 {
        ...
        public final List getAttachedFile() {
            return attachedFile;
        }

        public final void setAttachedFile(List attachedFile) {
            this.attachedFile = attachedFile;
        }
    }

    /**
     * @param propertyWriterImpl
     *            The propertyWriterImpl to set.
     */
